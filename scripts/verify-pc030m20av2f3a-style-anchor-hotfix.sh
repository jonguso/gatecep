...
grep -Fq 'feePanel:' mobile/app/broker-accounts.js
grep -Fq 'verifyRowActive:' mobile/app/broker-accounts.js
...
echo "PASS — fee-management styles are installed through stable StyleSheet anchor."
echo "PASS — no hard-coded Trade fee policy is copied into broker accounts."
echo "PC-030M20AV2F3A verification complete."
