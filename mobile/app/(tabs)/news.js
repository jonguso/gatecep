...
const s = StyleSheet.create({
  screen: { flex: 1, backgroundColor: "#020617" }, content: { width: "100%", maxWidth: 960, alignSelf: "center", padding: 22, paddingTop: 70, paddingBottom: 128 }, title: { color: "white", fontSize: 32, fontWeight: "900" }, subtitle: { color: "#94a3b8", marginTop: 8, lineHeight: 22 }, status: { marginTop: 18, padding: 16, borderRadius: 20, backgroundColor: "rgba(6,182,212,.10)", borderColor: "rgba(6,182,212,.4)", borderWidth: 1 }, statusTop: { flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: 10 }, statusTitle: { color: "#67e8f9", fontWeight: "900", fontSize: 17, flex: 1 }, refresh: { backgroundColor: "#155e75", borderRadius: 12, paddingHorizontal: 12, paddingVertical: 9 }, refreshText: { color: "#67e8f9", fontWeight: "900" }, body: { color: "#cbd5e1", marginTop: 7, lineHeight: 20 }, tabs: { marginTop: 20, flexDirection: "row", flexWrap: "wrap", gap: 8 }, tab: { paddingHorizontal: 14, paddingVertical: 10, borderRadius: 14, backgroundColor: "#1e293b" }, active: { backgroundColor: "#9333ea" }, tabText: { color: "#94a3b8", fontWeight: "900" }, activeText: { color: "white", fontWeight: "900" }, summary: { marginTop: 18, flexDirection: "row", flexWrap: "wrap", gap: 10 }, metric: { width: "47%", flexGrow: 1, minWidth: 140, backgroundColor: "#0f172a", borderRadius: 16, padding: 14 }, metricLabel: { color: "#94a3b8", fontSize: 12 }, metricValue: { color: "white", fontWeight: "900", marginTop: 4 }, card: { marginTop: 18, backgroundColor: "#0f172a", borderRadius: 20, padding: 16 }, cardTitle: { color: "#67e8f9", fontWeight: "900", fontSize: 18 }, row: { paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: "#1e293b" }, top: { flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: 10 }, badge: { borderRadius: 999, paddingHorizontal: 9, paddingVertical: 5, maxWidth: "72%" }, official: { backgroundColor: "#065f46" }, high: { backgroundColor: "#991b1b" }, reported: { backgroundColor: "#334155" }, badgeText: { color: "white", fontSize: 11, fontWeight: "900" }, date: { color: "#94a3b8", fontSize: 12 }, newsTitle: { color: "white", fontWeight: "900", marginTop: 8, lineHeight: 21 }, source: { color: "#67e8f9", marginTop: 6, fontSize: 12 }, open: { color: "#a78bfa", fontWeight: "900", marginTop: 9, fontSize: 12 }, itemActions: { flexDirection: "row", flexWrap: "wrap", gap: 18 }
});
