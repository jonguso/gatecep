...
export default function Calendar() {
  ...
  const load = useCallback(async () => {
    ...
    const [localResult, remoteResult, portfolioResult] = await Promise.allSettled([
