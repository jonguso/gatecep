...
export function buildRecoveryBasketExecution({
  ...
  const orders = rows.map((row, index) =>
    normalizeReviewOrder({
      ...
      side: "BUY",
      allocationBudget: n(row.proposedAmount),
      amount:
