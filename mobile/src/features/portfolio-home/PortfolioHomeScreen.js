...
const styles = StyleSheet.create({
  ...
  utilityRow: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginTop: 8 }, accountSelector: { flexGrow: 1.65, flexBasis: 240, minWidth: 0, minHeight: 54, paddingHorizontal: 13, borderRadius: 16, borderColor: "#334155", borderWidth: 1, backgroundColor: "#0f172a", flexDirection: "row", alignItems: "center" }, accountCopy: { flex: 1, minWidth: 0 }, accountLabel: { color: "#64748b", fontSize: 9, fontWeight: "900" }, accountName: { color: "#f8fafc", fontWeight: "900", marginTop: 3 }, accountChevron: { color: "#67e8f9", fontSize: 22, fontWeight: "900" }, priceButton: { flexGrow: 1, flexBasis: 160, minWidth: 0, minHeight: 54, borderRadius: 16, borderWidth: 1, paddingHorizontal: 11, justifyContent: "center" }, priceButtonLive: { backgroundColor: "#052e2b", borderColor: "#0f766e" }, priceButtonVerified: { backgroundColor: "#23180b", borderColor: "#92400e" }, priceButtonLabel: { color: "#94a3b8", fontSize: 9, fontWeight: "900" }, priceButtonValue: { color: "#f8fafc", fontSize: 12, fontWeight: "900", marginTop: 3 },
  ...
  hero: { marginTop: 8, backgroundColor: "#1d0b38", borderColor: "#6b21a8", borderWidth: 1, borderRadius: 18, paddingVertical: 10, paddingHorizontal: 13 }, heroCompact: { paddingVertical: 8, paddingHorizontal: 12, borderRadius: 16 }, heroLabel: { color: "#d8b4fe", fontSize: 9, fontWeight: "900" }, heroValue: { color: "white", fontSize: 25, fontWeight: "900", marginTop: 2 }, heroValueCompact: { fontSize: 23, marginTop: 1 }, gain: { color: "#86efac", fontWeight: "900", fontSize: 11, marginTop: 2 }, loss: { color: "#fca5a5", fontWeight: "900", fontSize: 11, marginTop: 2 }, quickMetrics: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginTop: 7 }, quickMetricsCompact: { marginTop: 6 }, quickMetric: { flexGrow: 1, flexBasis: 120, minWidth: 0, backgroundColor: "#09051d", borderRadius: 10, paddingVertical: 6, paddingHorizontal: 8 }, quickLabel: { color: "#94a3b8", fontSize: 8 }, quickValue: { color: "white", fontWeight: "900", fontSize: 11, marginTop: 2 },
